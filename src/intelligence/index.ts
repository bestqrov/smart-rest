// ─── Smart Intelligence Platform — Public API (K30-K33 + K35-K44) ──────────
...
// "memory:" key namespace; no vectors/embeddings). Still exactly one
// eventBus subscription for the whole module. No built-in
// agents/rules/executors/templates/namespaces ship except the Data Hub
// knowledge source and the built-in model catalog (both direct
// reuse/reference data, not business rules); nothing here is
// business-specific.
